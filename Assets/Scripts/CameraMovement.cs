...
public class CameraMovement : MonoBehaviour
{
    ...
    void Update()
    {
        if (playerObject1 != null && playerObject2 != null && gameManager.gameState == MightyGamePack.GameState.Playing)
        {
            ...
            midPoint += playerObject2.transform.position - new Vector3(0.0f, 0.0f, 4.0f); //special offset to decline camera    
            midPoint += playerObject1.transform.position -new Vector3(0.0f, 0.0f, 4.0f);
